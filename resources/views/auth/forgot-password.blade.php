                ...
                <div class="sign_right signup_right">
                    <div class="sign_inner signup_inner">
                        ...
                        <form action="#" class="row login_form">
                            ...
                            <div class="col-lg-12 form-group">
                                <div class="small_text">Nouveau mot de passe</div>
                                <div class="confirm_password">
                                    <input id="confirm-password" name="confirm-password" type="password" class="form-control" placeholder="Entrez votre nouveau mot de passe" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-12 form-group">
                                <div class="small_text">Confirmation du mot de passe</div>
                                <div class="confirm_password">
                            ...
                            <div class="col-lg-12 text-center">
                                <button type="submit" class="btn action_btn thm_btn">Retrouver mon mot de passe</button>
                            </div>
                        </form>
                    </div>
                </div>
