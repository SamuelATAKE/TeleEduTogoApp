    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div class="">
                    <img style="width: 85%; height: 85%" src="img/logo.png')}}" class="logo-icon-2" alt="" />
                </div>
                <div>
                    <h4 class="logo-text">SukuuShare</h4>
                </div>
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="{{ route('utilisateurs.eleves') }}">
                ...
                <li>
                    <a href="{{ route('utilisateurs.etudiants') }}">
                        <div class="parent-icon icon-color-3"> <i class="bx bx-conversation"></i>
                        </div>
                        <div class="menu-title">Etudiants</div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('utilisateurs.administrateurs') }}">
                ...
                <li>
                    <a href="widgets.html">
                        ...
                        <div class="menu-title">Devoirs</div>
                    </a>
                </li>
                <li>
                    <a href="javascript:;">
                        ...
                        <div class="menu-title">Examens</div>
                    </a>
                </li>
                <li>
                ...
                <li class="menu-label">Niveaux</li>
                <li>
                    <a href="{{ route('niveaux.classes') }}">
                        <div class="parent-icon icon-color-1"> <i class="bx bx-comment-edit"></i>
                        </div>
                        <div class="menu-title">Classes</div>
                    </a>
                </li>
                <li class="menu-label">Forums</li>
                <li>
                    <a href="javascript:;">
                        <div class="parent-icon icon-color-1"> <i class="bx bx-comment-edit"></i>
                        </div>
                        <div class="menu-title">Forums en cours</div>
                    </a>
                </li>
                <li>
                    <a href="javascript:;">
                        ...
                        <div class="menu-title">Forums fermés</div>
                    </a>
                </li>
                <li class="menu-label">Contributions</li>
                <li>
                    <a href="{{ route('admin.contributions.list') }}">
                ...
                <li>
                    <a href="{{ route('admin.contribution.non_validated') }}">
                        <div class="parent-icon icon-color-1"> <i class="bx bx-list"></i>
                        </div>
                    ...
                    <ul class="navbar-nav">
                                ...
                                <div class="header-message-list">
                                    ...
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="msg-name">Oscar Garner <span class="msg-time float-right">8
                                                        min
                                                        ago</span></h6>
                                    ...
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="msg-name">Amelia Doe <span class="msg-time float-right">22
                                                        min
                                                        ago</span></h6>
                                    ...
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="msg-name">Cristina Jhons <span class="msg-time float-right">2
                                                        hrs
                                                        ago</span></h6>
                                    ...
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="msg-name">James Caviness <span class="msg-time float-right">4
                                                        hrs
                                                        ago</span></h6>
                                    ...
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="msg-name">Peter Costanzo <span class="msg-time float-right">6
                                                        hrs
                                                        ago</span></h6>
                                    ...
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="msg-name">David Buckley <span class="msg-time float-right">2
                                                        hrs
                                                        ago</span></h6>
                                                <p class="msg-info">Various versions have evolved over</p>
                                            </div>
                                    ...
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="msg-name">Thomas Wheeler <span class="msg-time float-right">2
                                                        days
                                                        ago</span></h6>
                                    ...
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="msg-name">Johnny Seitz <span class="msg-time float-right">5
                                                        days
                                                        ago</span></h6>
                                ...
                                <div class="header-notifications-list">
                                    ...
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="msg-name">24 PDF File<span class="msg-time float-right">19
                                                        min
                                                        ago</span></h6>
                                    ...
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="msg-name">Time Response <span class="msg-time float-right">28
                                                        min
                                                        ago</span></h6>
                                    ...
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="msg-name">New Comments <span class="msg-time float-right">4
                                                        hrs
                                                        ago</span></h6>
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="msg-name">Your item is shipped <span
                                                        class="msg-time float-right">5 hrs
                                                        ago</span></h6>
                                    ...
                                    <a class="dropdown-item" href="javascript:;">
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="msg-name">New 24 authors<span class="msg-time float-right">1
                                                        day
                                                        ago</span></h6>
                        ...
                        <li class="nav-item dropdown dropdown-user-profile">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;"
                                ...
                                <div class="media user-box align-items-center">
                                    <div class="media-body user-info">
                                        <p class="user-name mb-0">Docteur Parfait</p>
                            ...
                            <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item"
                                    href="javascript:;"><i class="bx bx-user"></i><span>Profil</span></a>
                                <a class="dropdown-item" href="javascript:;"><i
                                        class="bx bx-cog"></i><span>Paramètres</span></a>
                                <a class="dropdown-item" href="javascript:;"><i
                                        class="bx bx-tachometer"></i><span>Tableau de bord</span></a>
                                <a class="dropdown-item" href="javascript:;"><i
                                        class="bx bx-cloud-download"></i><span>Téléchargements</span></a>
                                <div class="dropdown-divider mb-0"></div> <a class="dropdown-item"
                                    href="javascript:;"><i class="bx bx-power-off"></i><span>Déconnexion</span></a>
                            </div>
                        </li>
                        <li class="nav-item dropdown dropdown-language">
                            ...
                            <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item"
                                    href="javascript:;"><i class="flag-icon flag-icon-de"></i><span>German</span></a>
                                <a class="dropdown-item" href="javascript:;"><i
        ...
        <!--footer -->
        <div class="footer">
            <p class="mb-0">SukuuShare @2023 | Developpé par : <a href="#">ENT-TOGO</a>
            </p>
        </div>
        <!-- end footer -->
    </div>
