                                            ...
                                            <div class="tab-pane fade active show" id="v-pills-tour" role="tabpanel" aria-labelledby="v-pills-tour-tab">
                                                <div class="d-flex">
                                                    <ul class="list-unstyled tab_list w_100">
                                                        ...
                                                        <li><a class="active" href="doc-ref-shortcuts.html">Keyboard Shortcuts</a></li>
                                                    </ul>
                                                </div>
                                                <div class="text">
                                                    <a href="#">
                ...
                <div class="col-lg-7 col-md-8 doc-middle-content">
                    <article id="post" class="shortcode_info documentation_info tour_content">
                        <div class="documentation_body" id="documentation">
                            ...
                            <div class="tour_item">
                                <h4 class="c_head load-order-2">Ask questions, get answer no distractions</h4>
                            ...
                            <div class="border_bottom"></div>
                            <div class="tour_item">
                                <h4 class="c_head">Get answers to practical</h4>
                                <div class="row flex-row-reverse align-items-center tour_intro_item">
                                    <div class="col-sm-7">
                                        <div class="tour_preview_img wow fadeInRight" data-wow-delay="0.3s">
                                            <img class="img-fluid" src="img/tour_img2.png" alt="">
                                        </div>
                                    </div>
                                    <div class="col-sm-5 tour_info_content">
                                ...
                                <div class="row align-items-center tour_intro_item">
                                    <div class="col-sm-7">
                                        <div class="tour_preview_img wow fadeInLeft" data-wow-delay="0.7s">
                                            <img class="img-fluid" src="img/tour_img3.png" alt="">
                                        </div>
                                    </div>
                                    <div class="col-sm-5 tour_info_content">
                            ...
                            <div class="highlight_text mt-5">
                                <h4>Text Tooltips</h4>
                                <p>He nicked it chip shop argy-bargy brilliant get stuffed mate absolutely bladdered smashing, <span class="tooltips_one" data-toggle="tooltip" data-placement="top" title="Your text here">codswallop tosser</span> hunky-dory cheers in my flat bite your arm off, cracking goal up <span class="tooltips_two" data-toggle="tooltip" data-placement="top" title="Editar">the duff cheeky bugger zonked why</span>. Burke cras Richard grub say bits and bobs mush my lady tinkety tonk old fruit crikey fantastic vagabond, sloshed blower barney bender is bobby you mug daft argy-bargy.</p>
                            </div>
                        </div>
                        <footer>
                            <div class="border_bottom"></div>
                            <div class="row feedback_link">
                                ...
                                <div class="col-lg-6">
                                    <p>Was this page helpful? <a href="#" class="h_btn">Yes</a><a href="#" class="h_btn red">No</a></p>
                                </div>
                            </div>
                        </footer>
                    </article>
